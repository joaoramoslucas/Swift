...
https://github.com/user-attachments/assets/a544724f-b100-4b4e-bfbc-70af66af3dae


## 🔨 Funcionalidades do projeto
- Listagem de restaurantes;
- Autenticação de login para ADM via API;
- Listagem das categorias de restaurantes;
- Listagem de produtos oferecidos pelo restaurante;
- Conexão com API, requisições, GET/POST/UPDATE/DELETE;
- Carrossel de imagens destacando os destaques do momento;
- Autenticação com o FireBase para o sistema de Login de Usuários padrão;
- Sistema de acesso ADM e Usuário, cada um com suas configurações devidas;
