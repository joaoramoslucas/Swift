...
struct StorageHome: View {
    ...
    var body: some View {
        VStack {
            ...
            inputField(title: "Nome da Loja", placeholder: "Digite o nome da loja", text: $storeName).padding(.top, 32)
            inputField(title: "CNPJ da Loja", placeholder: "Digite o CNPJ", text: $storeCNPJ, keyboard: .numberPad).padding(.top, 15)
        ...
        .navigationTitle("Informações da Loja").navigationBarBackButtonHidden(true)
